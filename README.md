...
## تحديثات الواجهة وإسناد الملفات
- يمكن الآن إسناد الملف إلى أكثر من قسم باستخدام جدول `resource_categories`.
- تم الحفاظ على `resources.category_id` كقسم أساسي للتوافق مع البيانات القديمة.
- تم إضافة Migration رقم 0004 لترحيل العلاقات القديمة تلقائيًا.
- ملفات Excel تظهر بأيقونة Excel واضحة في المكتبة والصفحة الرئيسية.
- تم توسيط العلامة المائية للّوقو في الخلفية بنسبة شفافية منخفضة.
